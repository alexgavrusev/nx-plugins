...
const generatePublishableLibrary = async (
  ...
  updateJson(tree, 'tsconfig.json', (tsConfig) => {
    // do not compile imports into `require`s
  ...
  updateJson<PackageJson & { sideEffects: boolean | string[] }>(
    ...
    'package.json',
    (packageJson) => {
      // "type": "commonjs" will break module imports
      // "type": "module" will break commonjs imports
      // TODO: do not remove when Nx follows a better esm wrapper exports structure
      // see https://nodejs.org/api/packages.html#approach-1-use-an-es-module-wrapper and https://github.com/nrwl/nx/issues/20009
      delete packageJson.type;

      // this will be generated by rollup
